...
class NavigationSubMenu(list):
    ...
    SUB_MENU_RENT = [
        ...
        (20, "Vodič za iznajmljivanje", f"{ui_config.base_url}/blog/vodic-za-iznajmljivanje-nekretnine"),
        (21, "Lista agencija", f"{ui_config.base_url}/agencije"),
        (22, "Apartmani i stan na dan", f"{ui_config.base_url}/izdavanje-stanova?period=na_dan")
    ]
    SUB_MENU_NEW = [
        (1, "Sva novogradnja", f"{ui_config.base_url}/novogradnja"),
        (2, "Novogradnja u Beogradu", f"{ui_config.base_url}/novogradnja/beograd"),
        (3, "Novogradnja u Novom Sadu", f"{ui_config.base_url}/novogradnja/novi-sad"),
        (4, "Novogradnja u Nišu", f"{ui_config.base_url}/novogradnja/nis"),
        (5, "Novogradnja na Zlatiboru", f"{ui_config.base_url}/novogradnja/zlatibor"),
        (6, "Novogradnja u Pančevu", f"{ui_config.base_url}/novogradnja/pancevo"),
        (7, "Novogradnja u Kragujevcu", f"{ui_config.base_url}/novogradnja/kragujevac"),
        (8, "Novogradnja u Vrnjačkoj Banji", f"{ui_config.base_url}/novogradnja/vrnjacka-banja"),
        (9, "Novogradnja u Subotici", f"{ui_config.base_url}/novogradnja/subotica"),
        (10, "Novogradnja u Jagodini", f"{ui_config.base_url}/novogradnja/jagodina"),
        (11, "Novogradnja na Divčibarama", f"{ui_config.base_url}/novogradnja/divcibare-okolne-lokacije-valjevo"),
        (12, "Novogradnja u Valjevu", f"{ui_config.base_url}/novogradnja/valjevo"),
        (13, "Novogradnja u Velikom Gradištu", f"{ui_config.base_url}/novogradnja/veliko-gradiste"),
        (14, "Novogradnja na Tari", f"{ui_config.base_url}/novogradnja/tara"),
        (15, "Novogradnja u Zrenjaninu", f"{ui_config.base_url}/novogradnja/zrenjanin"),
        (16, "Novogradnja u Loznici", f"{ui_config.base_url}/novogradnja/loznica"),
        (17, "Novogradnja u Rumi", f"{ui_config.base_url}/novogradnja/ruma"),
        (18, "Novogradnja u Bečeju", f"{ui_config.base_url}/novogradnja/becej"),
        (19, "Novogradnja u Prokuplju", f"{ui_config.base_url}/novogradnja/prokuplje"),
        (20, "Novogradnja u Vršcu", f"{ui_config.base_url}/novogradnja/vrsac"),
        (21, "Novogradnja u Inđiji", f"{ui_config.base_url}/novogradnja/indjija"),
        (22, "Novogradnja u Sremskoj Mitrovici", f"{ui_config.base_url}/novogradnja/gradske-lokacije-sremska-mitrovica"),
        (23, "Novogradnja u Novim Banovcima",
         f"{ui_config.base_url}/novogradnja/novi-banovci-okolne-lokacije-stara-pazova"),
